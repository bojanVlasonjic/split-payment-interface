...
insert into account(id, number, recipient_name, recipient_address, creator_id) values (-1, "111-11-11", "PDV", "Blabla 2", -1);
insert into account(id, number, recipient_name, recipient_address, creator_id) values (-2, "222-22-22", "Donation", "Blabla 1", -1);
insert into account(id, number, recipient_name, recipient_address, creator_id) values (-3, "333-33-33", "Research", "Blabla 3", -1);
